...
export function Certifications() {
  ...
  return (
    <section
      ...
      className="relative bg-background border-t border-edge/30 pt-10 pb-8 md:pb-12 lg:pb-20 overflow-hidden"
    >
      <Container>
        {/* Header Section */}
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-6">
          <div className="max-w-2xl">
            ...
            <h3 className="text-[26px] md:text-[32px] lg:text-[36px] xl:text-[42px] font-bold leading-[1.1] tracking-tight text-foreground mb-4">
              Continuous Learning
            </h3>
